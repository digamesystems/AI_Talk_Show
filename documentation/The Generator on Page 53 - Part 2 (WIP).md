...
- ⁴ Martin, R.C. ("Uncle Bob"). "The Future of Programming" (talk, multiple editions from 2016 onward). [youtube.com/watch?v=ecIWPzGEbFc](https://www.youtube.com/watch?v=ecIWPzGEbFc) — the same warning cited in [the last essay](PLACEHOLDER-LINK-TO-ESSAY-2-ADD-AFTER-THURSDAY-PUBLISH) and Part 1.
